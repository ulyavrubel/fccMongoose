...
mongoose.connect(
  "mongodb+srv://ulya:qweasdzxc@cluster0-mtgfe.mongodb.net/test?authSource=admin",
...
ulya.name = "ulya";
ulya.age = 31;
ulya.favoriteFoods = ["mango", "okroshka"];

var createAndSavePerson = function(done) {
  ulya.save(function(err, data) {
    if (err) {
      done(err);
    }
    done(null, data);
...
// var arrayOfPeople = [
//                       {name: "Ulya", age: 31, favoriteFoods: ["okroshka", "mango"]},
//                       {name: "Artem", age: 31, favoriteFoods: ["beer", "meat"]},
//                       {name: "Goldie", age: 4, favoriteFoods: ["catfood", "water"]}
//                     ];
...
var findEditThenSave = function(personId, done) {
  ...
  Person.findById({ _id: personId }, (err, result) => {
    err ? console.log(err) : result.favoriteFoods.push(foodToAdd);
